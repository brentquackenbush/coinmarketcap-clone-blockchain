...
const styles = {
    trendingWrapper: 'mx-auto max-wscreen-2xL',
    ...
    <div className='text=white'>
        <div className={styles.trendingWrapper}> 
            <div className='flex justify-between'>
                <h1 className={styles.h1}>Today's Cryptocurrencies Prices by Market</h1>
            ...
            <div className='flex'>
                ...
                <p> &nbsp; decrease over the last day. 
                    <span className='underline'>Read More
                    </span>
                </p>
            </div>
            <br/>
            <div className={styles.flexCenter}>
                    ...
                    {trendingData} />
                    <TrendingCard title = 'Biggest Gainers'
                    icon = {gainers} trendingData = 
                    {trendingData} />
                    <TrendingCard title = 'Recently'
                    icon = {recent} trendingData = 
                    {trendingData} />
